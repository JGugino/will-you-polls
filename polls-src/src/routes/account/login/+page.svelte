...
<svelte:head>
    <title>Will You? - Login to your account</title>
</svelte:head>
...
<section class='login-section'>
    ...
    {/if}
    <form on:submit|preventDefault|stopPropagation={handleLoginForm}>
        <input class="create-input" type="text" name="login-username" id="login-username" placeholder="Username" required>
        <input class="create-input" type="password" name="login-password" id="login-password" placeholder="Password" required>
        <button class="create-button" type="submit">Login</button>
    </form>
    <a href="/account/signup">Need an account? Signup here</a>
</section>
